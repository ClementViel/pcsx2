...
if(${PCSX2_TARGET_ARCHITECTURES} MATCHES "x86_64" OR ${PCSX2_TARGET_ARCHITECTURES} MATCHES "i386" OR ${PCSX2_TARGET_ARCHITECTURES} MATCHES "armv6" OR ${PCSX2_TARGET_ARCHITECTURES} MATCHES "armv7")
	if((${PCSX2_TARGET_ARCHITECTURES} MATCHES "x86_64" OR ${PCSX2_TARGET_ARCHITECTURES} MATCHES "armv6" OR ${PCSX2_TARGET_ARCHITECTURES} MATCHES "armv7") AND (CMAKE_BUILD_TYPE MATCHES "Release" OR PACKAGE_MODE))
		message(FATAL_ERROR "
...
message(STATUS "Finishing BuildParameters")
